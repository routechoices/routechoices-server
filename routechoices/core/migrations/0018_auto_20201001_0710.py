    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imei', models.CharField(max_length=32, unique=True, validators=[routechoices.lib.validators.validate_imei])),
                ('device', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='physical_device', to='core.device')),
            ],
            options={
