...
L.Control.EventState = L.Control.extend({
  ...
  setLive() {
    ...
    this._div.innerHTML =
      '<div class="m-0 py-0 px-2"><div style="background-color:red;color: white;" class="px-1 rounded d-flex align-items-center"><div style="line-height:0.7em"><i style="font-size:.8em" class="fa-solid fa-circle blink mx-1"></i></div><div>' +
