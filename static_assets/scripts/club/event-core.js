  ...
  competitorList.forEach(function (competitor, ii) {
    ...
    div.html(
      '<div class="float-start color-tag" style="margin-right: 5px; cursor: pointer"><i class="media-object fa fa-circle fa-3x icon-sidebar" style="color:' +
        ...
        ' viewBox="0 0 48 48" width="20px"><path d="M28.05 42.1q-2.55 0-4.275-1.775Q22.05 38.55 22.05 35.7q0-2.5 1.175-4.3 1.175-1.8 2.925-3 1.75-1.2 3.725-1.825t3.575-.775q-.15-2.85-1.225-4.1-1.075-1.25-3.025-1.25t-3.65 1.175Q23.85 22.8 21 26.7q-3.15 4.2-5.075 5.65Q14 33.8 11.7 33.8q-2.15 0-3.925-1.45T6 27.4q0-1.6 1.125-4.125T11 16.3q1.3-1.9 1.875-3.15t.575-2.1q0-.55-.3-.875-.3-.325-.9-.325-.45 0-1 .25t-1.2.8q-.55.5-1.25.5t-1.2-.55q-.55-.55-.55-1.275 0-.725.55-1.225Q8.75 7.3 9.9 6.8t2.35-.5q2.1 0 3.425 1.4Q17 9.1 17 11.2q0 1.75-.925 3.5t-2.925 4.8q-2.25 3.35-2.925 4.95-.675 1.6-.675 3.2t.825 2.1q.825.5 1.725.5 1.2 0 2.45-1.15 1.25-1.15 3.85-4.55 3.4-4.4 5.9-6.025 2.5-1.625 5.35-1.625 3.3 0 5.2 2.425 1.9 2.425 2.15 6.325h3.25q.7 0 1.225.525Q42 26.7 42 27.4q0 .75-.525 1.275-.525.525-1.225.525H37q-.5 7.75-3.45 10.325-2.95 2.575-5.5 2.575Zm.15-3.55q1.55 0 3.325-2 1.775-2 2.025-7.25-2.45.25-5.2 2t-2.75 4.75q0 1.15.675 1.825t1.925.675Z"/>' +
        "</svg></button>" +
...
function updateText() {
  ...
  return fetch(`${langFile}?v=2022090401`)
