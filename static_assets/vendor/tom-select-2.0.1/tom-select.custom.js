...
(function (global, factory) {
	...
	function preserve_on_blur () {
	  ...
	  this.onBlur = function (e) {
	    ...
	    return function (e) {
	      ...
	      var input = this.control_input;
	      var inputValue = input.value; // Do the default actions

	      var searchResults = this.currentResults.items; // If there's only one search result, auto select it
	...
	TomSelect.define('preserve_on_blur', preserve_on_blur);
