...
RUN apt-get update -qq && \
    apt-get install -y --no-install-recommends g++ libgdal-dev libjpeg-dev zlib1g-dev libwebp-dev libmagic-dev libgl1 libpq5 libjxl-dev && \
    apt-get clean -y && \
...
RUN apt-get update -qq && \
    apt-get install -y --no-install-recommends git libgdal-dev libjpeg-dev zlib1g-dev libwebp-dev libmagic-dev libgl1 libpq5 libglib2.0-0 libjxl-dev && \
    apt-get clean -y && \
    rm -rf /var/lib/apt/lists/* /usr/share/doc /usr/share/man
